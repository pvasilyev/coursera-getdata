...
run_analysis <- function() {
  ...
  # prepare the working directory with the raw data:
  ...
  # read features and activities (to cover AC3 and AC4):
...
# read two sets of data: train and test;
# here is all the magic to merge to data sets (rbind) and merge with activities
...
# to cover AC2: extracts only the measurements on the mean and standard deviation for each measurement. 
